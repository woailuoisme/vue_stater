<template>
    ...
    >
        <v-img
            ...
            <v-card-title class="flex-nowrap">Top 10 Australian beaches</v-card-title>
        </v-img>
        <v-card-subtitle class="pb-2">{{ product.created_at }}</v-card-subtitle>
        ...
        data() {
            return {
                product: {
                    ...
                    imageURL: "http://h.hiphotos.baidu.com/baike/c0%3Dbaike60%2C5%2C5%2C60%2C20/sign=ed5caf4e0df431ada8df4b6b2a5fc7ca/5366d0160924ab18c8c0abeb34fae6cd7a890b13.jpg",
                    price: "320.29",
